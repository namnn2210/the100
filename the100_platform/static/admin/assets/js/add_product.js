                        ...
                        <div class="classify-item-content">
                            <div class="d-flex align-items-enter wrapper-inp">
                                <div class="col-6 d-flex">
                                    ...
                                    <div id="btn-active-classify" data-index="${index + 1}" onclick="activeAddClassify(this)">
                            ...
                            <div id="error-${index + 1}" class="error-message"></div>
                        </div>
                    </div>
                    <div class="d-flex mb-3 wrapper-classify-content d-none">
                        <div class="col-2 type-title">Phân loại hàng</div>
                        <div id="list-type-${index + 1}" class="list-type">
                            <div id="type-${index + 1}-0" class="col-6 type wrapper-inp">
                                <div class="d-flex align-items-center">
                                    <div class="input-group input-group-sm">
                                        <input
                                            type="text"
                                    ...
                                    <button class="btn btn-sm trash" id="trash-${index + 1}-0" style="cursor: not-allowed; opacity: 0.65;">
                                        <i class="bi bi-trash"></i>
                                    </button>
                                </div>
                                <div id="error-${index + 1}-0" class="error-message"></div>
                            </div>
                        </div>
                    </div>

                    <div class="icon-remove-classify-item d-none" data-index="${index + 1}" onclick="removeClassifyItem(this)">
                        <i class="bi bi-x-lg"></i>
                    </div>
                </div>
                `;
                    ...
                    <div id="type-${parentIndex}-${index + 1}" class="col-6 type wrapper-inp">
                        <div class="d-flex align-items-center">
                            <div class="input-group input-group-sm">
                                <input
                                    type="text"
                                    id="classify-type-${parentIndex}-${index + 1}"
                                    class="form-control classify-type"
                                    data-parent-index="${parentIndex}"
                                    data-index="${index + 1}"
                                    placeholder="ví dụ: ${parentIndex == 0 ? 'màu đỏ, vàng' : 'S, M'} v.v"
                                    oninput="changeInputType(this)"
                                />
                                <span
                                    class="input-group-text"
                        ...
                        <div id="error-${parentIndex}-${index + 1}" class="error-message"></div>
                    </div>
                    `;
